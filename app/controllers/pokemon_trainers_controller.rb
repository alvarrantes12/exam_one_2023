class PokemonTrainersController < ApplicationController
  ...
  def create
    ...
    if @pokemon_trainer.save
      ...
      redirect_to pokemon_trainer_url(@pokemon_trainer), notice: t('activerecord.success.pokemon_trainer.create')
    else
  ...
  def update
    if @pokemon_trainer.update(pokemon_trainer_params)
      redirect_to pokemon_trainer_url(@pokemon_trainer), notice: t('activerecord.success.pokemon_trainer.update')
    else
  ...
  def destroy
   ...
   redirect_to pokemon_trainers_url, notice: t('activerecord.success.pokemon_trainer.delete')
  end
